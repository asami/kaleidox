...
libraryDependencies += "org.goldenport" %% "goldenport-record" % "1.3.15"

libraryDependencies += "org.goldenport" %% "goldenport-sexpr" % "2.0.6"

libraryDependencies += "org.smartdox" %% "smartdox" % "1.2.6"
