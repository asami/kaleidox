...
libraryDependencies += "org.goldenport" %% "goldenport-scala-lib" % "1.3.8"

// override goldenport-sexpr
libraryDependencies += "org.goldenport" %% "goldenport-record" % "1.3.44"

libraryDependencies += "org.goldenport" %% "goldenport-sexpr" % "2.0.23"

// libraryDependencies += "org.goldenport" %% "goldenport-statemachine" % "0.0.1"

libraryDependencies += "org.smartdox" %% "smartdox" % "1.3.8"
